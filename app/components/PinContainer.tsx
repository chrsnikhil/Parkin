  ...
  return (
    ...
    >
      <div
        ...
        className="absolute left-1/2 top-1/2 w-full h-full ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
      >
        <div
          style={{
            transform: transform,
          }}
          className="absolute left-1/2 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden w-full h-full -translate-x-1/2 -translate-y-1/2"
        >
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-full w-full rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
